...
- 📸 **Upload Foto dari HP:** Pedagang unggah foto produk langsung dari galeri (EXIF/GPS otomatis dibersihkan) — tanpa ribet URL.
- 🤝 **Kejujuran Bawaan:** Konten contoh ditandai jelas, pratinjau draf khusus pemilik, gerbang kualitas sebelum terbit ("angka statistik pastikan benar ya"), dan badge Buka/Tutup dihitung dari jam perangkat pembeli.
- 🔒 **Privasi & Keamanan:** Sesi anonim per perangkat, draf tak pernah bocor ke publik, unggahan divalidasi + anti path-traversal.

...
3. **Outcome Over Template:** Tujuan utama adalah **pembeli menghubungi via WhatsApp**, bukan sekadar halaman estetik yang tidak menjual.
...
| Parameter | Raw Code Gen (`umkmcepat` / v0 style) | UMKM Craft (JSON Modular Engine) |
|---|---|---|
| **Output AI** | File `.tsx` / `.jsx` mentah | Objek JSON Props terstruktur |
| **Token Usage per Turn** | ~4,000 - 8,000 tokens ($0.15 - $0.35) | ~300 - 600 tokens (**< $0.001**) |
| **Generasi Kecepatan** | 15 - 35 detik | **1 - 3 detik** |
| **Tingkat Error / Crash** | 5% - 15% (Syntax/Import Error) | **0% (Deterministic Components)** |
| **Kemudahan Edit Manual** | Sulit (harus minta AI lagi) | **Sangat Mudah (Visual Sidebar Controls)** |
| **Mobile Performance** | Bervariasi tergantung output AI | **100/100 Lighthouse Optimized** |

...
/**
 * 404 host tenant — dirender di LUAR wrapper .uc-site (notFound() dipanggil
 * sebelum wrapper tema), jadi dirancang self-sufficient: palet builder
 * paper/ink/cutline dengan aksen die-cut, bukan warna tema tenant.
 */

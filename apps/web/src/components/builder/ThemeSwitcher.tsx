      ...
      {THEME_PRESETS.map((p) => {
        ...
        return (
          <button
            ...
            className={`relative h-7 w-7 rounded-full transition-transform duration-150 ease-out hover:scale-110 focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-signal ${active ? "scale-110 ring-2 ring-signal ring-offset-2 ring-offset-card" : ""}`}
